...
<body style="margin: 0; background-color: #091548; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #091548;" width="100%">
        <tbody>
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #091548; background-position: center top; background-repeat: repeat;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td
                                    background="{{$message->embed(asset('img/mail/PasswordChanged') .'/background_2.png') }}">
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a
                                                                        href="{{ url('/') }}"><img alt="Main Image"
                                                                            src="{{ $message->embed(asset('img/mail/passwordChanged'). '/header3.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 232px; max-width: 100%;"
                                                                            title="Main Image" width="232" /></a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:30px;">Password
                                                                                Berhasil Direset</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                            Anda baru saja mereset password anda, jika
                                                                            bukan anda yang melaukannya, segera hubungi
                                                                            kami.</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.example.com/" style="height:40px;width:142px;v-text-anchor:middle;" arcsize="60%" stroke="false" fillcolor="#ffffff"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#091548; font-family:sans-serif; font-size:15px"><![endif]--><a
                                                                        ...
                                                                        target="_blank"><span
                                                                            style="padding-left:25px;padding-right:25px;font-size:15px;display:inline-block;letter-spacing:normal;"><span
                                                                                ...
                                                                                style="word-break: break-word;"><span
                                                                                    ...
                                                                                    style="line-height: 30px;"><strong>TERIMAKASIH</strong></span></span></span></a>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                            <strong>Email ini dikirim ke {{ $user->name
                                                                                }}</strong>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="5" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="Your Logo" src="{{
                                                                        $message->embed(asset('img/mail/passwordChanged'). '/logo.png')
                                                                        }}"
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Facebook"
                                                                                        height="32" src="{{
                                                                                        $message->embed(asset('img/mail/passwordChanged'). '/facebook2x.png')
                                                                                        }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Facebook"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    href="https://instagram.com/mushlih_31"
                                                                                    target="_blank"><img alt="Instagram"
                                                                                        height="32" src="{{
                                                                                        $message->embed(asset('img/mail/passwordChanged'). '/instagram2x.png')
                                                                                        }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Instagram"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    href="https://twitter.com/mushlih_31"
                                                                                    target="_blank"><img alt="Twitter"
                                                                                        height="32" src="{{
                                                                                        $message->embed(asset('img/mail/passwordChanged'). '/twitter2x.png')
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="">Copyright © 2022 by Mushlih,
                                                                                All rights reserved.<br /><br />Where to
                                                                                find us: 2022 Saudi Arabia</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 12px; text-align: center;">
                                                                            <span style=""><br />Changed your mind? You
                                                                                can <a href="{{ url('/') }}"
                                                                                    rel="noopener"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        class="html_block block-5" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                        width="100%">
                                                        <tr>
                                                            <td class="pad">
