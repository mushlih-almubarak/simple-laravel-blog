                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a
                                                                        href="{{ url('/') }}"><img alt="I'm an image"
                                                                            src="{{ $message->embed(asset('img/mail/ResetPassword') . '/Companify-Logo.png') }}"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a
                                                                        href="{{ url('/') }}"><img alt="I'm an image"
                                                                            class="big"
                                                                            src="{{ $message->embed(asset('img/mail/ResetPassword') . '/Img22x.jpg') }}"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="font-size:30px;color:#2b303a;"><strong>Lupa
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="color:#808389;font-size:15px;">Hi
                                                                                {{ $user->name }}, Klik tombol dibawah
                                                                                ini untuk
                                                                                mengatur ulang kata sandi anda.</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;">
                                                                            <span
                                                                                style="color:#808389;font-size:15px;">Jika
                                                                                bukan anda yang meminta ini, abaikan
                                                                                saja ya</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="I'm an image"
                                                                        class="big"
                                                                        src="{{ $message->embed(asset('img/mail/ResetPassword') . '/footer.png') }}"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a
                                                                        href="{{ url('/') }}"><img alt="Alternate text"
                                                                            src="{{ $message->embed(asset('img/mail/ResetPassword') . '/Logo-white.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 149px; max-width: 100%;"
                                                                            title="Alternate text" width="149" /></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Facebook"
                                                                                        height="32"
                                                                                        src="{{ $message->embed(asset('img/mail/ResetPassword') . '/facebook2x.png') }}"
                                                                            ...
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Twitter"
                                                                                        height="32"
                                                                                        src="{{ $message->embed(asset('img/mail/ResetPassword') . '/twitter2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Twitter"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Instagram"
                                                                                        height="32"
                                                                                        src="{{ $message->embed(asset('img/mail/ResetPassword') . '/instagram2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Instagram"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="LinkedIn"
                                                                                        height="32"
                                                                                        src="{{ $message->embed(asset('img/mail/ResetPassword') . '/linkedin2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="LinkedIn"
                                                                                        width="32" /></a></td>
                                                                        </tr>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="color:#95979c;font-size:12px;">Mushlih
                                                                                Almubarak Copyright © 2022</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
