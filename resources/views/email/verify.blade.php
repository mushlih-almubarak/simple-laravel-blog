                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a
                                                                        href="{{ url('/') }}"><img alt="I'm an image"
                                                                            src="{{ $message->embed(asset('img/mail/verify') . '/Companify-Logo.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 149px; max-width: 100%;"
                                                                            title="I'm an image" width="149" /></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><a
                                                                        href="{{ url('/') }}"><img alt="I'm an image"
                                                                            class="big"
                                                                            src="{{ $message->embed(asset('img/mail/verify') . '/Img4_2x.jpg') }}"
                                                                            style="display: block; height: auto; border: 0; width: 352px; max-width: 100%;"
                                                                            title="I'm an image" width="352" /></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="font-size:30px;color:#2b303a;"><strong>Verifikasikan
                                                                                    Email Anda</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="color:#808389;font-size:15px;">Selamat
                                                                                datang {{ $user->name }}! Klik tombol
                                                                                <strong>dibawah
                                                                                    ini</strong> untuk memverifikasikan
                                                                                email
                                                                                Anda!</span>
                                                                        </p>
                                                                    </div>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:62px;width:163px;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#1aa19c"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]-->
                                                                    <a href="{{ $tokenURL }}">
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                    dir="ltr"
                                                                                    style="margin: 0; word-break: break-word; line-height: 32px;"><strong>Verifikasi
                                                                                        Email</strong></span></span>
                                                                        </div>
                                                                    </a>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="I'm an image"
                                                                        class="big"
                                                                        src="{{ $message->embed(asset('img/mail/verify') . '/footer.png') }}"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="Alternate text"
                                                                        src="{{ $message->embed(asset('img/mail/verify') . '/Logo-white.png') }}"
                                                                        style="display: block; height: auto; border: 0; width: 149px; max-width: 100%;"
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Facebook"
                                                                                        height="32"
                                                                                        src="{{ $message->embed(asset('img/mail/verify') . '/facebook2x.png') }}"
                                                                            ...
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Twitter"
                                                                                        height="32"
                                                                                        src="{{ $message->embed(asset('img/mail/verify') . '/twitter2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Twitter"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="Instagram"
                                                                                        height="32"
                                                                                        src="{{ $message->embed(asset('img/mail/verify') . '/instagram2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Instagram"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 10px 0 10px;"><a
                                                                                    ...
                                                                                    target="_blank"><img alt="LinkedIn"
                                                                                        height="32"
                                                                                        src="{{ $message->embed(asset('img/mail/verify') . '/linkedin2x.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="LinkedIn"
                                                                                        width="32" /></a></td>
                                                                        </tr>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                style="color:#95979c;font-size:12px;">Etiam
